...
{% img /images/uploads/2008/09/struktur-folder-4-all.png  %}

Isi folder local repo sebagai berikut. 

{% img /images/uploads/2008/09/struktur-folder-4-local-repo.png  %}

Isi folder person-build sebagai berikut.

{% img /images/uploads/2008/09/struktur-folder-4-person-build.png  %}

Isi folder person-model sebagai berikut.
{% img /images/uploads/2008/09/struktur-folder-4-person-model.png  %}
